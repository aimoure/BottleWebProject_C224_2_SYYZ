...
<div class="hungarian-page">
    ...
    <div class="jumbotron">
        ...
        <p>
            <a href="/transport_practice" class="btn btn-warning btn-lg mt-3">Перейти к калькулятору</a>
        </p>
    </div>
    ...
    <div class="container">
       ...
       заносим значение тарифов на перевозку груза (\(C_{ij}\)).</p>
        ...
        <a href="/transport_practice" class="btn btn-primary btn-lg">Перейти к калькулятору</a>
    </div>
    </div>
</div>
