    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 task-container" style="margin-bottom: 40px;">
                <div class="task-card">
                    ...
                    <p><a class="btn" href="/transportation_practice">Перейти к решению</a></p>
                </div>
            </div>
            ...
            <div class="col-md-6 task-container" style="margin-bottom: 40px;">
                <div class="task-card">
                    ...
                    <p><a class="btn" href="/purpose_practice">Перейти к решению</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 task-container" style="margin-bottom: 40px;">
                <div class="task-card">
                    <div>
                        <h3>Прямая задача линейного программирования</h3>
                        <p>Оптимизирует целевую функцию при линейных ограничениях. Решается симплекс-методом.</p>
                    </div>
                    <p><a class="btn" href="/direct_lpp_practice">Перейти к решению</a></p>
                </div>
            </div>
            ...
            <div class="col-md-6 task-container" style="margin-bottom: 40px;">
                <div class="task-card">
                    ...
                    <p><a class="btn" href="/dual_lpp_practice">Перейти к решению</a></p>
                </div>
            </div>
        </div>
    </div>
