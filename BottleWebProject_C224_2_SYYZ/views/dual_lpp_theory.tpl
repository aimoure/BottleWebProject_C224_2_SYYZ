...
<div class="hungarian-page">
    ...
    <!-- Заглавный блок страницы с общей информацией -->
    <div class="jumbotron">
        <h1>Двойственная задача линейного программирования</h1>
        <p class="lead">
            Суть двойственной задачи линейного программирования состоит в том, чтобы для исходной (прямой) задачи составить 
            связанную с ней двойственную задачу.
        </p>
        <p>
    ...
    <div class="container">
        ...
        <!-- Блок с описанием теории двойственной задачи -->
        <section class="section">
            ...
            <p>
                ...
                Она позволяет получить альтернативное решение, а также оценить чувствительность исходной задачи и 
                интерпретировать значения двойственных переменных (теневых цен).
            </p>
        ...
        <!-- Блок с описанием метода решения двойственной задачи через симплекс-метод -->
        <section class="section">
        ...
        <!-- Блок с примером решения двойственной задачи -->
        <div class="section">
            ...
            <p>Для задачи максимизации с ограничениями вида \( \leq \), двойственная будет задачей минимизации 
            с ограничениями вида \( \geq \). Переменные двойственной задачи — \(y_1, y_2\) — будут связаны с ограничениями прямой задачи.</p>
        ...
        <!-- Блок с пошаговым решением двойственной задачи методом симплекс-метода -->
        <div class="section">
