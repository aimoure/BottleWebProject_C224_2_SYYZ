...
<div class="hungarian-page">
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <p class="text">Шаг 1: Приведение к стандартной форме (умножаем неравенства на −1 и вводим t<sub>1</sub>, t<sub>2</sub>):</p>
            <div class="math" style="text-align: center;">
                \[
                    -2y_1 - 1y_2 + t_1 = -3
                \]
            ...
            <table class="custom-table">
                <tr>
                    <th>Базис</th><th>y<sub>1</sub></th><th>y<sub>2</sub></th><th>t<sub>1</sub></th><th>t<sub>2</sub></th><th>Свободный член</th>
                </tr>
                <tr>
                    <td>t<sub>1</sub></td><td>-2</td><td>-1</td><td>1</td><td>0</td><td>-3</td>
                </tr>
                <tr>
                    <td>t<sub>2</sub></td><td>-1</td><td>-2</td><td>0</td><td>1</td><td>-2</td>
                </tr>
                <tr>
            ...
            <span class="step-item"><span>Ведущий столбец y<sub>1</sub> (–4), ведущая строка t<sub>1</sub> (–3/–2 = 1.5).</span></span>
            <span class="step-item"><span>Делим первую строку на –2, затем зануляем y<sub>1</sub> в остальных строках.</span></span>
            <table class="custom-table">
                <tr>
                    <th>Базис</th><th>y<sub>1</sub></th><th>y<sub>2</sub></th><th>t<sub>1</sub></th><th>t<sub>2</sub></th><th>Свободный член</th>
                </tr>
                <tr>
                    <td>y<sub>1</sub></td><td>1</td><td>0.5</td><td>-0.5</td><td>0</td><td>1.5</td>
                </tr>
                <tr>
                    <td>t<sub>2</sub></td><td>0</td><td>-1.5</td><td>-0.5</td><td>1</td><td>-0.5</td>
                </tr>
                <tr>
            ...
            <span class="step-item"><span>Ведущий столбец y<sub>2</sub> (–2), ведущая строка t<sub>2</sub> (–0.5/–1.5 ≈ 0.33).</span></span>
            <span class="step-item"><span>Делим вторую строку на –1.5, затем зануляем y<sub>2</sub> в остальных строках.</span></span>
            <table class="custom-table">
                <tr>
                    <th>Базис</th><th>y<sub>1</sub></th><th>y<sub>2</sub></th><th>t<sub>1</sub></th><th>t<sub>2</sub></th><th>Свободный член</th>
                </tr>
                <tr>
                    <td>y<sub>1</sub></td><td>1</td><td>0</td><td>-0.67</td><td>0.33</td><td>1.33</td>
                </tr>
                <tr>
                    <td>y<sub>2</sub></td><td>0</td><td>1</td><td>0.33</td><td>-0.67</td><td>0.33</td>
                </tr>
                <tr>
            ...
            <!-- Итоговый результат -->
            <p class="text">Результат: y<sub>1</sub> = 1.33, y<sub>2</sub> = 0.33, W = 6.67.</p>
